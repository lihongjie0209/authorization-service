...
func setDefaults(v *viper.Viper) {
	v.SetDefault("app.name", "authorization-service")
	...
	v.SetDefault("database.schema", "authorization")
	...
	v.SetDefault("jwt.issuer", "authorization-service")
	...
	v.SetDefault("auth.audience", "authorization-service")
	...
	v.SetDefault("migration.table", "authorization_schema_migrations")
...
func (c Config) Validate() error {
	...
	if c.App.Env == "production" && (c.Auth.JWKSURL == "" || c.Auth.Issuer == "" || c.Auth.Audience == "") {
		return errors.New("production auth requires jwks_url, issuer, and audience")
	}
