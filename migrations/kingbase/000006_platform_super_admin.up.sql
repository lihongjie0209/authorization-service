...
INSERT INTO permissions (id, tenant_id, code, name, resource_type, action, status, version, created_at, updated_at, created_by, updated_by, condition_expression)
...
INSERT INTO roles (id, tenant_id, code, name, description, data_scope, status, version, created_at, updated_at, created_by, updated_by)
...
INSERT INTO role_permissions (id, tenant_id, role_id, permission_id, status, version, created_at, updated_at, created_by, updated_by)
