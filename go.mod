module github.com/lihongjie0209/authorization-service
...
require (
	...
	github.com/lihongjie0209/microservice-platform-go v0.15.11
	github.com/lihongjie0209/platform-protos v0.56.5
